...
public:
  ...
  void sendData(const mathfu::Vector<T, Size>& vec, unsigned int offset) const { Renderer::sendBufferSubData(BufferType::UNIFORM_BUFFER,
                                                                                                     offset, sizeof(vec), vec.getDataPtr()); }
  template <typename T, std::size_t W, std::size_t H>
  void sendData(const mathfu::Matrix<T, W, H>& mat, unsigned int offset) const { Renderer::sendBufferSubData(BufferType::UNIFORM_BUFFER,
