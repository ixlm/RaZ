...
public:
  ...
  { 
    ...
    for (int i=0; i<2; i++)
      raw_vec[i] = vec[i];
    Renderer::sendUniformVector2(uniformIndex, raw_vec); 
  }
  ...
  { 
    ...
    for (int i=0; i<3; i++)
      raw_vec[i] = vec[i];
    Renderer::sendUniformVector3(uniformIndex, raw_vec); 
  }
  ...
  { 
    ...
    for (int i=0; i<4; i++)
      raw_vec[i] = vec[i];
    Renderer::sendUniformVector4(uniformIndex, raw_vec); 
  }
  ...
  { 
    ...
    for (int i=0; i<4; i++)
      raw_mat[i] = mat[i];
    // Renderer::sendUniformMatrix2x2(uniformIndex, raw_mat, 1, true); 
    Renderer::sendUniformMatrix2x2(uniformIndex, raw_mat); 
  }
  ...
  { 
    ...
    for (int i=0; i<9; i++)
      raw_mat[i] = mat[i];
    // Renderer::sendUniformMatrix3x3(uniformIndex, raw_mat, 1, true); 
    Renderer::sendUniformMatrix3x3(uniformIndex, raw_mat); 
  }
  ...
  { 
    ...
    for (int i=0; i<16; i++)
      raw_mat[i] = mat[i];
    // Renderer::sendUniformMatrix4x4(uniformIndex, raw_mat, 1, true); 
    Renderer::sendUniformMatrix4x4(uniformIndex, raw_mat); 
  }
